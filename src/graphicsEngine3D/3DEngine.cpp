...
private:
    ...
    void drawTriangle(float x1, float y1, float x2, float y2, float x3, float y3 /*,const graphics::Brush & brush*/)
    {
        graphics::Brush b;
        b.fill_color[0]=0.0f;
        b.fill_color[1]=0.0f;
        ...
        drawLine(x2, y2, x3, y3, b);
        drawLine(x3, y3, x1, y1, b);
    }
    ...
    void draw() {
        ...
        for (auto tri: meshCube.tris) {
                ...
                normal.z * (triTranslated.p[0].z - viewCamera.z) < 0.0f)
            {
                ...
                newBrush.fill_color[0] = 0.5f;
                newBrush.fill_color[1] = 0.3f;
                newBrush.fill_color[2] = 1.0f;

                // Rasterize triangle
                this->drawTriangle(triProjected.p[0].x, triProjected.p[0].y,
